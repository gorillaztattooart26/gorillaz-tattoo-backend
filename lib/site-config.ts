...
/**
 * Homepage nav links use `/#section` (not bare `#section`) so they resolve
 * correctly from the shared layout regardless of which route the visitor is
 * currently on — Next.js scrolls to the anchor after navigating home.
 */
