...
const ROW_1: Tile[] = [
  {
    ...
    alt: 'Japanese dragon leg sleeve tattoo — Gorillaz Tattoo Art',
  },
  {
    ratio: 1.62,
    src: '/images/portfolio/portfolio-19.jpg',
    alt: 'Black and grey back piece tattoo of three faces — Gorillaz Tattoo Art',
    grayscale: true,
  },
  {
    ratio: 0.66,
    src: '/images/portfolio/portfolio-100.jpg',
    alt: 'Fine line phoenix tattoo — Gorillaz Tattoo Art',
  },
]
...
const ROW_2: Tile[] = [
  {
    ...
    alt: 'Neo-traditional tiger and snake forearm tattoo — Gorillaz Tattoo Art',
    grayscale: true,
  },
  {
    ratio: 1.3,
    src: '/images/portfolio/portfolio-75.jpg',
    alt: 'Realism portrait tattoo of a bearded king with a trident — Gorillaz Tattoo Art',
  },
  {
    ratio: 0.74,
    src: '/images/portfolio/portfolio-14.jpg',
    alt: 'Custom hand tattoo — Gorillaz Tattoo Art',
    grayscale: true,
  },
]
      ...
      <div ref={trackRef} className="relative mt-2 md:mt-3.5 h-[225svh]">
        ...
        >
          ...
          <div className="mx-auto flex w-full max-w-[1360px] flex-col gap-2 px-6 md:flex-row md:gap-3.5 md:px-16">
            ...
            >
              <PhotoTile
                src="/images/portfolio/portfolio-140.jpg"
                alt="Black and grey dragon and mandala eye full sleeve tattoo — Gorillaz Tattoo Art"
                className="h-full w-full"
              />
            </div>
          </div>
          ...
          <div ref={growRef} className="absolute z-[2] overflow-hidden bg-[var(--gz-ink-900)]">
            <div ref={growImgRef} className="absolute inset-0" style={{ filter: 'grayscale(1) contrast(1.06)' }}>
              <PhotoTile
                src="/images/homepage-v2/hanya-mask-forearm.png"
                alt="Hannya mask black and grey forearm and hand tattoo — Gorillaz Tattoo Art"
                className="h-full w-full"
