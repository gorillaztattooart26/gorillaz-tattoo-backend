...
import { MobileNav } from '@/components/homepage-v2/MobileNav'
...
/**
 * Fixed navigation for the /homepage-v2 draft only — local to this route,
 * not the shared components/layout/Navbar.tsx the real site uses.
 */
export function Navbar() {
  ...
  // All breakpoints, all v2 pages (this Navbar is shared across
  // homepage-v2/aftercare-v2/portfolio-v2): hide the bar on scroll down,
  // bring it back on scroll up. Skipped near the very top (within one bar
  // height) so it doesn't flicker hidden on the tiny downward scrolls that
  // happen there.
