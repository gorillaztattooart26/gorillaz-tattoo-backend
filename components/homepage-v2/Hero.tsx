...
/**
 * /homepage-v2 hero. Fully static (CSS-driven entrance animations only) —
 * Server Component. The feature tile plays the real studio reel
 * (public/videos/homepage-v2/hero-video.mp4).
 */
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1360px] flex-col items-stretch gap-8 px-6 md:px-10 lg:flex-row lg:flex-wrap lg:items-end">
        ...
        >
          ...
          >
            <source src="/videos/homepage-v2/hero-video.mp4" type="video/mp4" />
          </video>
        ...
        >
          ...
          <div className="flex flex-wrap gap-3">
            <CtaPill href={V2_SECTIONS.inquire}>Inquire now</CtaPill>
            <CtaPill href={V2_SECTIONS.work} iconVariant="default">
              View the portfolio
            </CtaPill>
          </div>
        </div>
