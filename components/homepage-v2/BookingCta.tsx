...
/**
 * Full-bleed "Book a consultation" CTA banner for /homepage-v2, shown just
 * before the Footer (wired up in app/homepage-v2/page.tsx, since Footer
 * itself lives in the shared layout rather than the page).
 */
