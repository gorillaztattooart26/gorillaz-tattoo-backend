...
/**
 * Homepage FAQ section — a two-column layout (heading + intro on the left,
 * full accordion list on the right). Uses its own local AccordionItem
 * rather than a shared wrapper, since the layout here is two-column.
 */
export function FAQ() {
