...
/**
 * /aftercare-v2 hero — full-bleed studio photo with a slow Ken Burns zoom
 * (the `gz-kenburns` keyframes already defined in tokens.css for this
 * purpose) desaturated and darkened under a bottom gradient, matching the
 * Claude Design handoff. Server Component, same static-entrance convention
 * as homepage-v2's Hero.
 */
