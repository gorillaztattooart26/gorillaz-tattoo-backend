...
interface CtaPillSharedProps {
   ...
   *  (e.g. sections/PortfolioGallery's reveal link), where a competing
...
/**
 * Shared arrow-circle pill CTA used across the public marketing design
 * system — Navbar, Hero, MobileNav, Footer, both PortfolioGallery variants,
 * InquireForm, ArtistsPreview, About and BookingCta.
 */
