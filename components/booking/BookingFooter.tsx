...
export function BookingFooter() {
  return (
    <footer className="mt-12 border-t border-[var(--border)] pt-10 pb-16 text-center">
      <Logo className="mx-auto h-10 w-auto" width={160} height={51} />

      <div className="mt-6 flex flex-col items-center gap-2 text-xs text-[var(--foreground)]/50">
        ...
        <div className="mt-2 flex items-center gap-4">
          <a href={siteConfig.social.facebook} target="_blank" rel="noopener noreferrer" className="hover:text-[var(--foreground)]">
            facebook
          </a>
          <a href={siteConfig.social.instagram} target="_blank" rel="noopener noreferrer" className="hover:text-[var(--foreground)]">
            instagram
          </a>
