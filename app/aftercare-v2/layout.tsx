...
/**
 * Typefaces for the /aftercare-v2 draft only, mirroring
...
/**
 * Isolated layout for the /aftercare-v2 draft — reuses homepage-v2's
 ...
 * production Aftercare page and its layout are never touched.
 */
export default function AftercareV2Layout({ children }: { children: React.ReactNode }) {
  return (
